...
<li class="nav-item dropdown">
    {{-- <a class="nav-link dropdown-toggle" href="https://{{ $item['enlace'] }}" data-bs-toggle="dropdown">{{ $item['name'] }} <span class="caret"></span></a> --}}
    {{-- <a class="nav-link dropdown-toggle" href="{{ route('pagina', $item['nombre_pagina']) }}" data-bs-toggle="dropdown">{{ $item['name'] }} <span class="caret"></span></a> --}}
    ...
    <ul class="dropdown-menu">
        @foreach ($item['submenu'] as $submenu)
            @if ($submenu['submenu'] == [])
                <li>
                    {{-- <a class="dropdown-item" href="https://{{ $submenu['enlace'] }}">{{ $submenu['name'] }} <span class="caret"></span></a> --}}
